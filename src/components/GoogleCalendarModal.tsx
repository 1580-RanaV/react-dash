  ...
  return (
    <div className="flex flex-col items-center gap-6 px-8 pb-8 pt-8 text-center animate-fade-up">
      ...
      <div className="flex flex-col gap-1.5">
        <p className="text-lg font-bold text-stone-900 dark:text-stone-100">Google Calendar Connected</p>
        <p className="text-sm leading-relaxed text-stone-500 dark:text-stone-400">
          Your Google Workspace account is now linked to your project.
        </p>
      </div>
      <div className="flex items-center gap-2 rounded-xl px-4 py-2.5" style={{ background: "var(--muted)", border: "1px solid var(--border)" }}>
        ...
        <span className="text-sm text-stone-500 dark:text-stone-400">Google Calendar</span>
      </div>
      <button
        type="button"
        onClick={onClose}
        ...
        {connected ? <ConnectedScreen onClose={onClose} /> : (
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3.5 px-6 pt-6 pb-7 pr-14">
              ...
              />
              <div>
                <p className="text-base font-bold text-stone-900 dark:text-stone-100">Connect Your Google Account</p>
                ...
                <ol className="flex flex-col gap-3">
                  ...
                  <li className="flex flex-col gap-2 text-sm">
                    <div className="flex items-start gap-2.5">
                      ...
                      <span className="text-stone-700 dark:text-stone-200">Use this Client-ID to search for Instantly:</span>
                    </div>
                    <div
                  ...
                  <li className="flex items-start gap-2.5 text-sm text-stone-700 dark:text-stone-200">
                    <span className="mt-0.5 shrink-0 font-semibold text-stone-400 dark:text-stone-500 w-4">4.</span>
